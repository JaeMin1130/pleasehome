  ...
  return (
    <div style={{
      ...
      <section style={{ marginBottom: '24px' }}>
        <h2 style={{ fontSize: 'var(--font-size-md)', fontWeight: 'var(--font-weight-bold)', marginBottom: '12px', color: 'var(--text-primary)' }}>1. 수집하는 개인정보 항목</h2>
      ...
      <section style={{ marginBottom: '24px' }}>
        <h2 style={{ fontSize: 'var(--font-size-md)', fontWeight: 'var(--font-weight-bold)', marginBottom: '12px', color: 'var(--text-primary)' }}>2. 쿠키 및 타사 광고(구글 애드센스) 사용에 관한 안내</h2>
        <p style={{ color: 'var(--text-secondary)' }}>
      ...
      <section style={{ marginBottom: '24px' }}>
        <h2 style={{ fontSize: 'var(--font-size-md)', fontWeight: 'var(--font-weight-bold)', marginBottom: '12px', color: 'var(--text-primary)' }}>3. 개인정보의 보호 및 문의</h2>
        <p style={{ color: 'var(--text-secondary)' }}>

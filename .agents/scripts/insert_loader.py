...
def force_fail_log(db_path, doc_path, error_message, title=None, institution=None, subscription_type=None, ann_id=None):
    """
    ...
    try:
        ...
        if not ann_id:
            ...
            cursor.execute(
                ...
                VALUES (?, ?, ?, ?);
                """,
                (final_title, final_inst, final_sub_type, relative_doc_path)
            )
